...
namespace PasswordPolicy
{
  public static class Utils
  {
    ...
    {
      char[] digits = new char[] { s[0], s[1], s[2], s[3], s[4], s[5], s[6], s[7] };
    ...
    public static bool HasIncreasingStraight(string s)
    {
      bool result = false;
    ...
    public static bool HasTwoDoubles(string s)
    {
      bool result = false;      
    ...
    public static bool HasForbiddenChars(string s)
    {
      foreach (var c in s)
        if ((c == 'i') || (c == 'o') || (c == 'l'))
          return true;
